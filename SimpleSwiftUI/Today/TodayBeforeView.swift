...
struct TodayBeforeViewModel {
    ...
    static var sample: TodayBeforeViewModel {
        TodayBeforeViewModel(days: [
            Day(daysPast: 1, imageName: "today_1", starCount: 3),
            ...
            Day(daysPast: 6, imageName: "today_6", starCount: 1),
        ])
    }
}
                        ...
                        VStack(alignment: .leading) {
                            ...
                            HStack(alignment: .bottom, spacing: 2) {
                                ForEach(model.days) { day in
                                    TodayOtherDayView(daysPast: day.daysPast, imageName: day.imageName, starCount: day.starCount)
                                        .frame(maxWidth: 150)
                                }
                            }
                        }
